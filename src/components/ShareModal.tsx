          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-stone-500">
                192-bit Cryptographic Entropy • Server-Side Expiry
              </p>
            </div>
          </div>
          <button
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1 text-sm text-stone-700">
          ...
          <div className="p-3.5 rounded-xl bg-amber-50/80 border border-amber-200/80 text-xs text-amber-950 space-y-1.5">
            ...
            <p className="text-stone-700 leading-relaxed">
              Recipients need no account to view this reflection. The link uses a random 192-bit token (never the Firestore doc ID), is blocked from direct client Firestore reads, and is verified server-side on every request.
            </p>
          </div>
              ...
              <div className="space-y-2 bg-stone-50 p-3 rounded-xl border border-stone-200">
                ...
                <label className="flex items-start gap-2.5 cursor-pointer text-xs">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-stone-500 mt-0.5">
                      Omits emotional vulnerability telemetry by default.
                    </p>
                  </div>
                </label>
              </div>
